	...
	return (
		<main className='w-full flex flex-col min-h-screen'>
			...
			<section className='p-10 text-white gradient rounded-t-[30px] flex flex-col items-center justify-center gap-5'>
				...
				<div className='flex items-center justify-center flex-wrap gap-x-20 gap-y-10 max-md:gap-y-7'>
					<motion.div
						className='h-[150px] w-[350px] border-4 rounded-xl p-4 border-white'
						initial={{ opacity: 0, y: 20 }}
						animate={{ opacity: 1, y: 0 }}
						transition={{ duration: 0.5 }}
						whileHover={{ y: -10 }}
					...
					>
						...
						<p>An AI powered chat bot to help you with coding queries.</p>
					</motion.div>
					<motion.div
						className='h-[150px] w-[350px] border-4 rounded-xl p-4 border-white'
						initial={{ opacity: 0, y: 20 }}
